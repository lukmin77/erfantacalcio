                        ...
                        <Box sx={{ p: 1 }}>
                            <Stack direction="row" spacing={1} justifyContent="space-between" alignItems="center">
                                ...
                                <input
                                    ...
                                    id="upload-input"
                                />
                                <Button color="info" variant="contained" onClick={process.env.NEXTAUTH_URL?.startsWith("https://") ? handleUploadVercel : handleUpload} startIcon={<CloudUpload />} disabled={uploading}>
                                    Upload
                                </Button>
                            </Stack>
                        </Box>
