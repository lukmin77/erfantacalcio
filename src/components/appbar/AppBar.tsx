...
import { Avatar, IconButton, ListItemButton, ListItemIcon, ListItemText, Menu, Tooltip } from "@mui/material";
        ...
        >
            <Container maxWidth="lg">
                ...
                >
                    ...
                    >
                        <Typography variant="h1" onClick={handleGoToHome} 
                            sx={{
                                ...
                                <div>
                                    ...
                                    >
                                        {guestListItems()}
                                            ...
                                            >
                                                <ListItemIcon sx={{ mr: 2 }}><ExitToApp color='primary'></ExitToApp></ListItemIcon>
