...
interface AutocompleteTextboxProps {
    onItemSelected: (idGiocatore: number | undefined, inputValue: string | undefined) => void;
    items: iElements[];
}

export default function AutocompleteTextbox({ onItemSelected, items}: AutocompleteTextboxProps) {
        ...
        <React.Fragment>
            <Autocomplete
                ...
                filterOptions={(options, params) => {
                    ...
                    if (params.inputValue !== '' && items.find(c => c.label === params.inputValue) === undefined) {
                        filtered.push({
                            id: 0,
