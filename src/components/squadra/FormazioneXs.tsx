import { AutoGraph, ExpandMore, Filter1, Filter2, Filter3, Filter4, Filter5, Filter6, Home, HourglassTop, Save } from "@mui/icons-material";
import { Box, CircularProgress, Grid, List, ListItem, ListItemText, MenuItem, Select, type SelectChangeEvent, Typography, Stack, Button, Snackbar, Alert, Accordion, AccordionDetails, AccordionSummary, IconButton, useTheme, useMediaQuery, Divider, Tooltip } from "@mui/material";
...
function Formazione({ onActionChange: onActionActive, idSquadra }: FormazioneProps) {
                                ...
                                <Grid container spacing={0} key={player.idGiocatore}>
                                    <Grid item xs={9}>
                                        <div onClick={() => handleClickPlayer(player)}>
                                            <ListItem sx={{ cursor: 'pointer', zIndex: 2, paddingTop: '0px', paddingBottom: '0px', paddingLeft: '0px' }}>
                            ...
                            <Stack direction={'row'}>
                                {giornate.length > 1 ? (
                                    <Select size='small'
                                        ...
                                        margin='dense'
                                        required
                                        sx={{ m: '2px', backgroundColor: '#2e865f', color: 'white', opacity: 0.8, fontSize: '11px' }}
                                        name="giornata"
                                    ...
                                    <Typography variant={'body2'} sx={{ lineHeight: 2.66, marginRight: '3px' }}>{giornate[0]?.Title}</Typography>
                                )}
                                <Select size='small'
                                    variant='outlined'
                            ...
                            <>
                                <Grid item sm={8} xs={12}>
                                    <>
                                        ...
                                        <Accordion>
                                            <AccordionSummary expandIcon={<ExpandMore />}>
                                                <Typography variant="h5">In panchina ({panca.length})</Typography>
                                            </AccordionSummary>
                                            <AccordionDetails>
                                                <Grid container spacing={0}>
                                                    {renderPanca(['P', 'D', 'C', 'A'])}
                                ...
                                <Grid item sm={4} xs={12}>
                                    <Accordion defaultExpanded={true}>
                                        <AccordionSummary expandIcon={<ExpandMore />}>
                                            <Typography variant="h5">In campo ({campo.length})</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Box sx={{
                                                borderStyle: 'none',
